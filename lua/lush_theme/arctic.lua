...
local theme = lush(function(injected_functions)
    ...
    return {
        ...
        DiffAdd        { CursorLine }, -- Diff mode: Added line |diff.txt|
        DiffChange     { bg = colors.comment.da(20), fg = colors.white }, -- Diff mode: Changed line |diff.txt|
        DiffDelete     { bg = colors.bg.da(30) }, -- Diff mode: Deleted line |diff.txt|
        DiffText       { Visual }, -- Diff mode: Changed text within a changed line |diff.txt|
        -- EndOfBuffer    { }, -- Filler lines (~) after the end of the buffer. By default, this is highlighted like |hl-NonText|.
        TermCursor     { Cursor }, -- Cursor in a focused terminal
        -- TermCursorNC   { }, -- Cursor in an unfocused terminal
        ErrorMsg       { bg = colors.error }, -- Error messages on the command line
        -- VertSplit      { }, -- Column separating vertically split windows
        Folded         { bg = colors.bg.li(2), fg = colors.comment, gui = "italic" }, -- Line used for closed folds
        ...
        Substitute     {  bg = colors.op, fg = colors.bg }, -- |:substitute| replacement text highlighting
        ...
        -- Comment        { fg = colors.bg.li(25).de(20), gui = "italic" }, -- Any comment
